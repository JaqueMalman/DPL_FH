...
public  class  Canvas  extends JComponent  implements MouseListener, MouseMotionListener {
	...
	/** Invoked when a mouse button has been pressed on a component. */
	 private void  mousePressed__wrappee__Linha  (MouseEvent e) {
	...
	public void mousePressed(MouseEvent e) {
		mousePressed__wrappee__Linha(e);
	...
	/** Invoked when a mouse button has been released on a component. */
	 private void  mouseReleased__wrappee__Linha  (MouseEvent e) {
	...
	public void mouseReleased(MouseEvent e) {
		mouseReleased__wrappee__Linha(e);
	...
	/** Invoked when the mouse is dragged over a component */
	 ...
	 private void  mouseDragged__wrappee__Linha  (MouseEvent e) {
	...
	public void mouseDragged(MouseEvent e) {
		mouseDragged__wrappee__Linha(e);
		if (figureSelected == FigureTypes.RECT) {
			mouseDraggedRect(e);
		}
	}
